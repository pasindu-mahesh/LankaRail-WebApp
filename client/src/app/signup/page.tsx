...
import { Train, Mail, Lock, Eye, EyeOff, User, Users, Car } from "lucide-react"
        ...
        <Card className="border-0 shadow-2xl">
          <CardHeader className="text-center pb-6">
            ...
            <CardDescription className="text-gray-600">
              Join thousands of users tracking trains across Sri Lanka
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <form className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <input id="terms" type="checkbox" className="rounded border-gray-300 text-red-600 focus:ring-red-500" />
              ...
              <Button className="w-full h-12 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800">
                Create Account
              </Button>
            </form>
